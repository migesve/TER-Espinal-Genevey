...
const formSchemaReponse = Yup.object().shape({
    ...
    schema1_inclinaison: Yup.number().integer().required("inclinaison du schema1 répondu requis").min(1, "l'inclinaison du schema1 répondue doit être suppérieur ou égale à 0").max(2, "L'inclinaison du schema1 rémpondue doit être inférieur ou égale à 100"),
    schema2_angle: Yup.number().integer().required("angle du schema2 répondu requis").min(0, "l'angle du schema2 répondu doit être suppérieur ou égale à 0").max(361, "L'angle répondu du schema2 doit être inférieur ou égale à 360"),
    schema2_inclinaison: Yup.number().integer().required("inclinaison du schema2 répondu requis").min(1, "l'inclinaison du schema2 répondue doit être suppérieur ou égale à 0").max(2, "L'inclinaison du schema2 rémpondue doit être inférieur ou égale à 100"),
