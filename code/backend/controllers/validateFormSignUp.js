...
const formSchemaSignUp = Yup.object().shape({
    username: Yup.string().required("Nom d'utilisateur requis").min(4, "Le nom d'utilisateur doit contenir au moins 4 caractères").max(30, "Le nom d'utilisateur doit contenir au plus 30 caractères"),  
    ...
    cohorte: Yup.string().required("Cohorte requise").min(2, "La cohorte doit contenir au moins 1 caractères").max(30, "La cohorte doit contenir au plus 30 caractères"),
});
