...
} from "./chunk-32MHLCOZ.js";
import {
  _extends,
  init_extends
} from "./chunk-ZVVCVZNQ.js";
...
function GridContextProvider({
  ...
  const apiRef = React2.useRef(privateApiRef.current.getPublicApi());
  return (0, import_jsx_runtime.jsx)(GridRootPropsContext.Provider, {
    value: props,
    children: (0, import_jsx_runtime.jsx)(GridPrivateApiContext.Provider, {
      value: privateApiRef,
      children: (0, import_jsx_runtime.jsx)(GridApiContext.Provider, {
        value: apiRef,
        children
      })
    })
...
var DataGridRaw = React3.forwardRef(function DataGrid(inProps, ref) {
  const props = useDataGridProps(inProps);
  const privateApiRef = useDataGridComponent(props.apiRef, props);
  if (true) {
    validateProps(props, propValidators);
  }
  return (0, import_jsx_runtime2.jsx)(GridContextProvider, {
    privateApiRef,
    props,
    children: (0, import_jsx_runtime2.jsxs)(GridRoot, _extends({
      className: props.className,
      style: props.style,
      sx: props.sx,
      ref
    }, props.forwardedProps, {
      children: [(0, import_jsx_runtime2.jsx)(GridHeader, {}), (0, import_jsx_runtime2.jsx)(GridVirtualScroller, {}), (0, import_jsx_runtime2.jsx)(GridFooterPlaceholder, {})]
    }))
  });
});
var DataGrid2 = React3.memo(DataGridRaw);
DataGridRaw.propTypes = {
   ...
   */
  forwardedProps: import_prop_types.default.object,
  /**
   ...
   * @default 166
   */
  rowPositionsDebounceMs: import_prop_types.default.number,
  /**
   ...
   */
  rowSelectionModel: import_prop_types.default.oneOfType([import_prop_types.default.arrayOf(import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.string]).isRequired), import_prop_types.default.number, import_prop_types.default.string]),
  /**
